...
export default function BusinessRegulatoryPage() {
  ...
  const conceptPDFs: ConceptPDFs = {
    ...
    "Business Maintenance": [
      {
        title: "Chapter-14 Maintenance of Registers and Records",
      ...
      {
        title:
          "Chapter-15 Identifying laws applicable to Various Industries and their compliances",
        src: "/pdf/bussiness/bussinessmaintaince/Identifying laws applicable to Various Industries and their compliances.pdf",
        download:
          "Identifying laws applicable to Various Industries and their compliances.pdf",
      },
      {
        title: "Chapter-17 Compliance's under labour Laws",
        src: "/pdf/bussiness/bussinessmaintaince/Compliance's under labour Laws.pdf",
        download: "Compliance's under labour Laws.pdf",
      },
      {
        title: "Chapter-18 Compliance's relating to environmental laws",
    ...
    "Procedure to Close a Business": [
      {
        title: "Chapter-19 Dormant Company",
        src: "/pdf/bussiness/procedure/Dormant Company.pdf",
        download: "Dormant Company.pdf",
      },
      {
        title:
          "Chapter-20 Strike off and Restoration of Name of Co and LLP",
        src: "/pdf/bussiness/procedure/Strike off and Restoration of Name of Co and LLP.pdf",
        download:
          "Strike off and Restoration of Name of Co and LLP.pdf",
      },
      {
        title:
          "Chapter-21 Corporate Insolvency Resolution Process, Liquidation & Winding Up - An Overview",
        src: "/pdf/bussiness/procedure/Corporate Insolvency Resolution Process,Liquidation &.winding up_ An Overview.pdf",
        download:
          "Corporate Insolvency Resolution Process,Liquidation &.winding up_ An Overview.pdf",
      },
    ],

    "Appendix of Lessons": [
      {
        title: "Lesson-01 INDIAN CONTRACT ACT, 1872",
        src: "/pdf/bussiness/appendix/INDIAN CONTRACT ACT, 1872.pdf",
        download: "INDIAN CONTRACT ACT, 1872.pdf",
      },
      {
        title: "Lesson-02 SPECIFIC RELIEF ACT, 1963",
        src: "/pdf/bussiness/appendix/SPECIFIC RELIEF ACT, 1963.pdf",
        download: "SPECIFIC RELIEF ACT, 1963.pdf",
      },
      {
        title: "Lesson-03 SALE OF GOODS ACT, 1930",
        src: "/pdf/bussiness/appendix/SALE OF GOODS ACT, 1930.pdf",
        download: "SALE OF GOODS ACT, 1930.pdf",
      },
      {
        title: "Lesson-04 NEGOTIABLE INSTRUMENT ACT, 1881",
        src: "/pdf/bussiness/appendix/NEGOTIABLE INSTRUMENT ACT, 1881.pdf",
        download: "NEGOTIABLE INSTRUMENT ACT, 1881.pdf",
      },
      {
        title: "Lesson-05 INTERPRETATION OF STATUTES",
        src: "/pdf/bussiness/appendix/INTERPRETATION OF STATUTES.pdf",
        download: "INTERPRETATION OF STATUTES.pdf",
      },
      {
        title: "Lesson-06 INDIAN STAMP ACT, 1899",
        src: "/pdf/bussiness/appendix/INDIAN STAMP ACT, 1899.pdf",
        download: "INDIAN STAMP ACT, 1899.pdf",
      },
      {
        title: "Lesson-07 ARBITRATION AND CONCILIATION ACT, 1996",
        src: "/pdf/bussiness/appendix/ARBITRATION AND CONCILIATION ACT, 1996.pdf",
        download: "ARBITRATION AND CONCILIATION ACT, 1996.pdf",
      },
      {
        title: "Lesson-08 TYPES OF BUSINESS ENTITIES",
        src: "/pdf/bussiness/appendix/TYPES OF BUSINESS ENTITIES.pdf",
        download: "TYPES OF BUSINESS ENTITIES.pdf",
      },
      {
        title: "Lesson-09 PUBLIC SECTOR ENTITIES",
        src: "/pdf/bussiness/appendix/PUBLIC SECTOR ENTITIES.pdf",
        download: "PUBLIC SECTOR ENTITIES.pdf",
      },
      {
        title: "Lesson-10 SHOP AND ESTABLISHMENT ACT, 1948",
        src: "/pdf/bussiness/appendix/SHOP AND ESTABLISHMENT ACT, 1948.pdf",
        download: "SHOP AND ESTABLISHMENT ACT, 1948.pdf",
      },
      {
        title: "Lesson-11 COMPANIES ACT, 2013",
        src: "/pdf/bussiness/appendix/COMPANIES ACT, 2013.pdf",
        download: "COMPANIES ACT, 2013.pdf",
      },
      {
        title: "Lesson-12 LIMITED LIABILITY PARTNERSHIP ACT, 2008",
        src: "/pdf/bussiness/appendix/LIMITED LIABILITY PARTNERSHIP ACT, 2008.pdf",
        download: "LIMITED LIABILITY PARTNERSHIP ACT, 2008.pdf",
      },
      {
        title: "Lesson-13 PARTNERSHIP ACT, 1932",
        src: "/pdf/bussiness/appendix/PARTNERSHIP ACT, 1932.pdf",
        download: "PARTNERSHIP ACT, 1932.pdf",
      },
      {
        title: "Lesson-14 INDIAN TRUST ACT, 1882",
        src: "/pdf/bussiness/appendix/INDIAN TRUST ACT, 1882.pdf",
        download: "INDIAN TRUST ACT, 1882.pdf",
      },
      {
        title: "Lesson-15 SOCIETIES REGISTRATION ACT, 1860",
        src: "/pdf/bussiness/appendix/SOCIETIES REGISTRATION ACT, 1860.pdf",
        download: "SOCIETIES REGISTRATION ACT, 1860.pdf",
      },
      {
        title: "Lesson-17 MULTI-STATE CO-OPERATIVE SOCIETIES ACT, 2002",
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="p-6 md:p-8 flex-1">
              ...
              <p className="mt-3 text-sm sm:text-base text-gray-600 leading-relaxed">
                Explore detailed course materials covering business setup, maintenance, compliance,
                and closure procedures with legal insights.
              </p>
            </div>
          </div>
        </div>
