  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 px-4">
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-lg text-center">
        <Image src={directax} alt="Direct Tax Laws Compliance (DTLC)" className="w-full h-56 object-cover rounded-xl mb-6"/>
        <h1 className="text-2xl font-bold text-[#0062cc] mb-4">Direct Tax Laws Compliance (DTLC)</h1>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-90 z-50 flex flex-col">
          ...
          <div className="flex justify-center p-4 bg-black bg-opacity-80">
            <a href="/pdf/DTLC.pdf" download className="inline-flex items-center gap-2 bg-[#0062cc] text-white px-5 py-2 rounded-lg hover:bg-blue-700 transition">
              <Download className="w-4 h-4"/> Download PDF
            </a>
          </div>
        </div>
