...
import { listMemberCommonCertificates } from "@/lib/commonCertificateStorage";
...
/** GET /api/member-common-certificates?membershipId=100202 */
export async function GET(req: Request) {
  try {
    ...
    const certificates = await listMemberCommonCertificates(
      supabase,
      membershipIdParam
    );
    ...
    console.error("member-common-certificates API error:", error);
    return NextResponse.json(
